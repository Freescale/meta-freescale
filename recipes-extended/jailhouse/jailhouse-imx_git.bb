...
# Scope this to the recipe's own module: "^kernel-module-.*" would make
# jailhouse-imx a provider for every kernel-module-* virtual, ahead of linux-imx.
PACKAGES_DYNAMIC += "^kernel-module-jailhouse.*"
# nooelint: oelint.vars.insaneskip
INSANE_SKIP:kernel-module-jailhouse-${KERNEL_VERSION} = "buildpaths"
